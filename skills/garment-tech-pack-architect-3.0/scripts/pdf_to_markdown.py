...
def pdf_to_markdown_with_tables(pdf_path, extract_tables=True, verbose=False):
    """
...
def main():
    ...
    # 命令行调用时启用详细日志
    markdown_content = pdf_to_markdown_with_tables(pdf_path, extract_tables, verbose=True)
